...
typedef struct {
  ...
  uint8_T c1_tp_Monitor0;
  uint8_T c1_f_tp_idle;
  uint8_T c1_tp_urgentstate;
  uint8_T c1_tp_Monitor1;
  uint8_T c1_b_tp_urgentstate;
  uint8_T c1_g_tp_idle;
  uint8_T c1_tp_Monitor2;
  uint8_T c1_c_tp_urgentstate;
  uint8_T c1_h_tp_idle;
  uint8_T c1_tp_Monitor3;
  uint8_T c1_d_tp_urgentstate;
  uint8_T c1_i_tp_idle;
  ...
  uint8_T c1_is_Monitor0;
  uint8_T c1_is_active_Monitor0;
  uint8_T c1_is_Monitor1;
  uint8_T c1_is_active_Monitor1;
  uint8_T c1_is_Monitor2;
  uint8_T c1_is_active_Monitor2;
  uint8_T c1_is_Monitor3;
  uint8_T c1_is_active_Monitor3;
  real_T c1_start[4];
  real_T c1_stop[4];
  real_T c1_openPSD[8];
